...
type AccountServiceClient interface {
	...
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*CreateAccountResponse, error)
}
...
func (c *accountServiceClient) Find(ctx context.Context, in *FindUser, opts ...grpc.CallOption) (*Account, error) {
	out := new(Account)
	err := c.cc.Invoke(ctx, "/AccountService/Find", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) FindMe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*FindMeResponse, error) {
	out := new(FindMeResponse)
	err := c.cc.Invoke(ctx, "/AccountService/FindMe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*CreateAccountResponse, error) {
	out := new(CreateAccountResponse)
...
type AccountServiceServer interface {
	...
	Login(context.Context, *LoginRequest) (*CreateAccountResponse, error)
...
func (UnimplementedAccountServiceServer) Find(context.Context, *FindUser) (*Account, error) {
...
func (UnimplementedAccountServiceServer) Login(context.Context, *LoginRequest) (*CreateAccountResponse, error) {
...
func _AccountService_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AccountService/Find",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).Find(ctx, req.(*FindUser))
	}
	return interceptor(ctx, in, info, handler)
}

func _AccountService_FindMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).FindMe(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AccountService/FindMe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).FindMe(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindMe",
			Handler:    _AccountService_FindMe_Handler,
		},
		{
			MethodName: "Login",
